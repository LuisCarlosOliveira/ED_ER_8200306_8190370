...
import org.example.Game.MovementStrategy.Interfaces.IMinimumSpanningTreeStrategy;
 ...
 */
public class MinimumSpanningTreeStrategy extends MovementStrategy implements IMinimumSpanningTreeStrategy {

    /**
     * Determines the next move of the bot based on the Minimum Spanning Tree (MST) of the game map.
     *
